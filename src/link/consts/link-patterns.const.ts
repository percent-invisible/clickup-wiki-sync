...
export const LINK_PATTERNS: Record<string, LinkPattern> = {
    // Page links with format: https://app.clickup.com/{workspace_id}/v/dc/{doc_id}/{page_id} with optional query params
    ...
    // Cross-document page links with format: https://app.clickup.com/{workspace_id}/docs/{doc_id}/{page_id} with optional query params
    ...
    // Document links with format: https://app.clickup.com/{workspace_id}/docs/{doc_id} with optional query params
    DOC_LINK: {
        type: LINK_TYPE.DOCUMENT,
