...
describe('LinkParser', () => {
    ...
    it('extracts regular markdown links', async () => {
    ...
    it('extracts ClickUp doc links', async () => {
    ...
    it('extracts ClickUp page links', async () => {
    ...
    it('extracts ClickUp linked page links', async () => {
    ...
    it('extracts empty markdown links', async () => {
    ...
    it('extracts inner link from ClickUp-escaped nested markdown links', async () => {
    ...
    it('extracts markdown links in table cells', async () => {
        const content =
    ...
    it('skips image markdown links', async () => {
        const content =
    ...
    it('parses phone links as unknown', async () => {
    ...
    it('parses task links as unknown', async () => {
    ...
    it('extracts relative links as EXTERNAL', async () => {
